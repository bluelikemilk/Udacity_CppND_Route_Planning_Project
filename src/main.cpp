...
{    
    ...
    cout << "Input the x coordiante of starting point (0-100): "<<endl;
    cin >> start_x;
    cout << "Input the y coordiante of starting point (0-100): "<<endl;
    cin >> start_y;
    cout << "Input the x coordiante of ending point (0-100): "<<endl;
    cin >> end_x;
    cout << "Input the x coordiante of ending point (0-100): "<<endl;
    cin >> end_y;
